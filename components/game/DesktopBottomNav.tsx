...
export default function DesktopBottomNav({
  ...
  return (
    <nav className="hidden md:flex fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-40">
      <div className="w-full max-w-7xl mx-auto flex items-center justify-around h-16 px-4">
        {/* Tablero */}
        <button
          onClick={onShowBoard}
          className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${
            activeTab === 'board' ? 'text-blue-600' : 'text-gray-600 hover:text-blue-600'
          }`}
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${
            activeTab === 'properties' ? 'text-green-600' : 'text-gray-600 hover:text-green-600'
          }`}
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 h-full transition-colors ${
            activeTab === 'history' ? 'text-purple-600' : 'text-gray-600 hover:text-purple-600'
          }`}
          title="Historial"
        >
          <svg className="w-6 h-6 mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
