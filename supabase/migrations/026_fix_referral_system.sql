-- Migración para corregir el sistema de referidos
-- Problema: Los referidos no se registran correctamente en registro con email y Google OAuth

-- Mejorar la función handle_new_user para asegurar que el perfil existe antes de procesar referido
