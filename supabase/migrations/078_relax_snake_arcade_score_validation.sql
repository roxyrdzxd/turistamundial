-- Ajusta la validacion de velocidad para el Snake Arcade con combos y frutas especiales.
-- La regla anterior podia rechazar partidas legitimas muy rapidas y bloquear ranking/retos.
