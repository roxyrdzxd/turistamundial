-- Actualizar función find_nearby_treasures para incluir badge_url
...
COMMENT ON FUNCTION find_nearby_treasures IS 'Encuentra tesoros cercanos a una ubicación geográfica. Incluye badge_url si el tesoro tiene medalla.';
