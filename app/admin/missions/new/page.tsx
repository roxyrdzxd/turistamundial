  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        alert('Error al crear misión: ' + (data.error || 'Error desconocido'))
        setSaving(false)
      }
    } catch (error) {
    ...
    <AdminLayout>
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-white mb-2">Crear Nueva Misión</h1>
            <p className="text-white/70">Agrega una nueva misión al juego</p>
          </div>
          <Link
            href="/admin/missions"
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ej: Primera Partida del Día"
              />
            </div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 border border-white/20 space-y-4">
            ...
            <div>
              ...
              <p className="text-xs text-white/60 mt-1">
                O escribe una acción personalizada en el campo de abajo
              </p>
            </div>
            ...
            <div>
              ...
              />
              <p className="text-xs text-white/60 mt-1">
                Número de veces que se debe realizar la acción
              </p>
            </div>
          </div>
